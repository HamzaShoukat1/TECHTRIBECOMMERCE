      ...
      <div className="mx-auto max-w-7xl grid grid-cols-1 gap-8 md:grid-cols-2 font-poppins lg:grid-cols-4">
        ...
        <div className="flex flex-col gap-6 lg:pl-12">
          ...
          <nav className="flex flex-col gap-6">
            ...
            <a href="/shop" className="text-sm font-bold text-black transition-colors hover:text-gray-600">Shop</a>
            <a href="/contact" className="text-sm font-bold text-black transition-colors hover:text-gray-600">Contact</a>
          </nav>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <nav className="flex flex-col gap-6">
            <a href="#" className="text-sm font-bold text-black transition-colors hover:text-gray-600">Payment Options</a>
            <a href="#" className="text-sm font-bold text-black transition-colors hover:text-gray-600">Returns</a>
            <a href="#" className="text-sm font-bold text-black transition-colors hover:text-gray-600">Privacy Policies</a>
          </nav>
        </div>
