            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  key={item.route}
                  href={item.route}
                  className={`text-sm font-medium transition-colors relative py-1 after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-full after:origin-bottom-right after:scale-x-0 after:bg-amber-600 after:transition-transform after:duration-300 hover:after:origin-bottom-left hover:after:scale-x-100 ${
                    isActive ? "text-amber-600 after:scale-x-100" : "text-gray-600 hover:text-gray-900"
                  }`}
                >
                  {item.name}
                </Link>
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          {!isAuthPage && (
            <>
              ...
              {/* Orders Counter Icon */}
              <Link href="/orders" className="p-2 text-gray-600 hover:text-gray-900 transition-colors rounded-full hover:bg-gray-50 relative">
