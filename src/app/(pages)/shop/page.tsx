        ...
        <div className="w-full max-w-[1400px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-[30px] justify-items-center">
          ...
          <div className="flex items-center gap-[10px] w-full max-w-[337px]">
            ...
            <div className="flex flex-col justify-center">
              ...
              <h4 className="font-semibold text-[20px] md:text-[25px] text-[#242424] leading-tight">
                High Quality
              </h4>

              <p className="text-[14px] md:text-[16px] text-[#898989] font-medium leading-normal mt-1 font-semibold">
